...
/**
 * Created by yu.song on 2017/5/3.
 */
public class VerifyCodeUtils {
    ...
    public static String generateVerifyCode(int verifySize,String sources){
        ...
        for(int i = 0;i <verifySize;i++){
            verifyCode.append(sources.charAt(ran.nextInt(codesLen-1)));
        }
    ...
    public static void outputImage(int w, int h, OutputStream outputStream, String verifyCode) throws IOException {
